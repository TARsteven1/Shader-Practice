    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.normalDir_WorldSpace=UnityObjectToWorldNormal(v.normal);
                return o;
            }
            float4 frag(VertexOutput i) : COLOR {
////// Lighting:
////// Emissive:
               // float lambert=max(0,dot(i.normalDir_WorldSpace,normalize(_WorldSpaceLightPos0.xyz)));
                float halflambert=dot(i.normalDir_WorldSpace,normalize(_WorldSpaceLightPos0.xyz))*0.5+0.5;
                return fixed4(halflambert,halflambert,halflambert,halflambert);
            }
            ENDCG
        }
    }
